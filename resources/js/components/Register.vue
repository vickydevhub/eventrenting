                    ...
                    <div class="card-body">
                        ...
                        <form action="javascript:void(0)" @submit="register" class="row" method="post">
                            ...
                            <div class="form-group col-12">
                                ...
                                <input type="text" name="phone_number" v-model="user.phone_number" id="phone_number" placeholder="Enter phone number" class="form-control">
                            </div>
                            ...
                            <div class="form-group col-12 my-2">
                                ...
                                <input type="password_confirmation" name="confirm_password" v-model="user.confirm_password" id="confirm_password" placeholder="Enter Password" class="form-control">
                            </div>
                            <!--<div class="form-group col-12 my-2">
